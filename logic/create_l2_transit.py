...
if __name__=="__main__":
    if (len(sys.argv) < 2):
        print("Please give l2_transit config file")
        exit(1)
    ...
    if raas_utils.client_exists_l2_transit(l2_transit_name):
        print("l2_transit already exists ", l2_transit_name)
        exit(1)
    ...
    try:
        ...
        try:
            ...
            raas_utils.client_add_l2_transit(hypervisor, l2_transit_name, l2_transit_capacity)

        except Exception as e:
            print("create l2_transit failed deleting transit", e)
        ...
        try:
            ...
            #print("ansible-playbook logic/transit/configure_transit.yml -i logic/inventory/hosts.yml -v --extra-vars '"+extra_vars+"'")
        ...
        print("create l2_transit failed python failed ", e)
